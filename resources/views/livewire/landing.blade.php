<div class="flex-grow flex flex-col">
    ...
    <section class="relative bg-white dark:bg-gray-950 overflow-hidden transition-colors duration-300">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 md:pt-32 md:pb-32 lg:flex lg:items-center lg:gap-12 text-center lg:text-left">
            <div class="lg:w-1/2">
                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 text-sm font-semibold mb-6 shadow-sm border border-orange-200 dark:border-orange-800/50">
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-gray-900 dark:text-white mb-6 leading-tight">
                ...
                <p class="text-lg sm:text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium">
            ...
            <div class="lg:w-1/2 mt-16 lg:mt-0 relative group perspective">
                <div class="absolute inset-0 bg-gradient-to-r from-orange-400 to-amber-300 dark:from-orange-600 dark:to-amber-500 rounded-3xl blur-2xl opacity-20 dark:opacity-30 group-hover:opacity-40 transition-opacity duration-500"></div>
                
                <div class="relative bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-3xl shadow-2xl overflow-hidden transform transition-transform duration-500 hover:scale-[1.02]">
                    <!-- Mock Browser Top -->
                    <div class="bg-gray-100 dark:bg-gray-800 px-4 py-3 flex items-center gap-2 border-b border-gray-200 dark:border-gray-700">
                        <div class="w-3 h-3 rounded-full bg-red-400"></div>
                        <div class="w-3 h-3 rounded-full bg-yellow-400"></div>
                        <div class="w-3 h-3 rounded-full bg-green-400"></div>
                        <div class="ml-4 flex-1 bg-white/50 dark:bg-gray-900/50 rounded-md h-5 px-3 flex items-center shadow-inner">
                            <span class="text-[10px] text-gray-500 dark:text-gray-400 font-mono">chaothuk.com</span>
                        </div>
                    </div>
                ...
                <!-- Floating badge -->
                <div class="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-4 animate-bounce hover:animate-none transition-all cursor-default z-10 flex items-center gap-4" style="animation-duration: 3s;">
                    <div class="w-12 h-12 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-2xl">
                        ⭐
                    </div>
                    <div>
                        <div class="text-sm text-gray-500 dark:text-gray-400 font-medium">คะแนนความพึงพอใจ</div>
                        <div class="text-xl font-black text-gray-900 dark:text-white">4.9/5.0</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-24 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <h2 class="text-3xl font-black text-gray-900 dark:text-white tracking-tight sm:text-4xl mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Feature 1 -->
                <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div class="w-14 h-14 bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 rounded-2xl flex items-center justify-center text-2xl mb-6 shadow-inner">
                        🎯
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">ค้นหางานแม่นยำ</h3>
                ...
                <!-- Feature 2 -->
                <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div class="w-14 h-14 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-2xl flex items-center justify-center text-2xl mb-6 shadow-inner">
                        🛡️
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">ระบบรีวิวที่เชื่อถือได้</h3>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
                ...
                <!-- Feature 3 -->
                <div class="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                    <div class="w-14 h-14 bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 rounded-2xl flex items-center justify-center text-2xl mb-6 shadow-inner">
                        💬
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-3">แชทติดต่อโดยตรง</h3>
                    <p class="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
    ...
    <section class="py-20 bg-white dark:bg-gray-950 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
                <div>
                    <h2 class="text-3xl font-black text-gray-900 dark:text-white tracking-tight sm:text-4xl mb-3">
                        งานขนส่งล่าสุด
                    </h2>
                    <p class="text-lg text-gray-600 dark:text-gray-400">
                ...
                <div class="mt-4 md:mt-0">
                    <a href="{{ route('frontend.works') }}" class="text-orange-600 dark:text-orange-400 font-semibold hover:underline flex items-center gap-1">
                        ดูงานทั้งหมด
    ...
    <section class="py-20 bg-white dark:bg-gray-950 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-br from-gray-900 to-gray-800 dark:from-gray-900 dark:to-black rounded-3xl p-10 md:p-16 shadow-2xl overflow-hidden relative">
                <!-- Abstract BG Elements -->
                <div class="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 rounded-full bg-orange-500/20 blur-3xl"></div>
                <div class="absolute bottom-0 left-0 -ml-20 -mb-20 w-64 h-64 rounded-full bg-blue-500/20 blur-3xl"></div>
                
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative z-10 text-center md:divide-x divide-gray-700">
                    <div class="px-4">
                        <div class="text-4xl md:text-5xl font-black text-white mb-2">{{ number_format($stats['users_count'] ?? 0) }}</div>
                        <div class="text-orange-400 font-medium">ผู้ใช้งานทั้งหมด</div>
                    </div>
                    <div class="px-4">
                        <div class="text-4xl md:text-5xl font-black text-white mb-2">{{ number_format($stats['works_count'] ?? 0) }}</div>
                        <div class="text-orange-400 font-medium">งานขนส่งในระบบ</div>
                    </div>
                    <div class="px-4">
                        <div class="text-4xl md:text-5xl font-black text-white mb-2">{{ number_format($stats['provinces_count'] ?? 0) }}</div>
                        <div class="text-orange-400 font-medium">จังหวัดที่รองรับ</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- CTA Section -->
    <section class="py-24 bg-orange-600 dark:bg-orange-700 text-center transition-colors duration-300">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <a href="{{ route('frontend.auth.register') }}" class="inline-block bg-white text-orange-600 font-bold text-lg px-10 py-4 rounded-full shadow-xl hover:bg-gray-50 hover:scale-105 transition-transform duration-300">
