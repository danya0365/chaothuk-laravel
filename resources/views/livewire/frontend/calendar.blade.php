<div class="max-w-4xl mx-auto px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold text-white">📅 ปฏิทินการจอง</h1>
    </div>
    ...
    <div class="bg-gray-900 rounded-2xl p-4 mb-6">
        ...
        <div class="grid grid-cols-7 gap-1 mb-2">
            @foreach(['อา', 'จ', 'อ', 'พ', 'พฤ', 'ศ', 'ส'] as $dow)
                <div class="text-center text-xs text-gray-500 font-medium py-1">{{ $dow }}</div>
            @endforeach
        </div>
        ...
        <div class="flex items-center gap-4 mt-4 text-xs text-gray-500">
            <div class="flex items-center gap-1.5">
                <span class="w-3 h-3 rounded-full bg-orange-500/20 border border-orange-500/50"></span>
                วันนี้
            </div>
            <div class="flex items-center gap-1.5">
                <span class="w-3 h-3 rounded-full bg-blue-500/15 border border-blue-500/50"></span>
                มีการจอง
            </div>
            <div class="flex items-center gap-1.5">
        ...
        <div class="bg-gray-900 rounded-2xl p-4">
            ...
            @if(empty($selectedDayBookings))
                <div class="text-center py-8">
                    ...
                    <p class="text-green-400 font-semibold">ว่าง — ไม่มีการจองในวันนี้</p>
                    <p class="text-gray-500 text-sm mt-1">คุณสามารถรับงานใหม่ได้</p>
                </div>
            @else
                <div class="space-y-3">
                        ...
                        <div class="bg-gray-800 rounded-xl p-4 border-l-4
                            ...
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex-1">
                                    ...
                                    <h4 class="font-semibold text-white">{{ $booking['title'] }}</h4>
