<div class="max-w-3xl mx-auto px-4 py-6"
    ...
    <form wire:submit="submit" class="space-y-4">
        <div class="bg-gray-900 rounded-2xl p-5 space-y-4">
            ...
            {{-- Location Picker --}}
            <div>
                <label class="block text-gray-400 text-sm mb-2">พิกัดสถานที่ทำงาน (ละติจูด/ลองจิจูด)</label>
                <div x-data="{
                    ...
                    <x-location-picker 
                        ...
                        class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-2.5 text-orange-400 focus:outline-none hover:bg-gray-700 transition font-semibold" />
