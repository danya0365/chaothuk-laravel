                    ...
                    @else
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg border border-indigo-100 dark:border-indigo-900 shadow-sm relative overflow-hidden">
                            ...
                            <div class="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700 relative z-10 text-right">
                                <button type="button" wire:click="reopenDispute" onclick="return confirm('คุณแน่ใจหรือไม่ที่จะรื้อฟื้นข้อพิพาทนี้กลับมาใหม่?');" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
