                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <img class="h-10 w-10 rounded-full object-cover border border-gray-200 dark:border-gray-700" src="{{ $province->image ? $province->image : 'https://ui-avatars.com/api/?name='.urlencode($province->name_en).'&background=random' }}" alt="">
                                    </div>
                                    <div class="ml-4">
