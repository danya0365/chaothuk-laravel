                                            ...
                                            <dl class="divide-y divide-gray-100 dark:divide-gray-700">
                                                <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                    ...
                                                    <dd
                                                        ...
                                                        <a
                                                            href="{{ route('backend.user-customers.show', $pointLog->userPoint?->customer->user_id) }}">
                                                            {{ $pointLog->userPoint?->customer->getPersonInfo()->getFullName() ?? 'ยังไม่ได้ระบุ' }}
                                                        </a>
                                                    </dd>
                                                </div>
                                                @if ($pointLog->points > 0)
                                                    <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                        ...
                                                        <dd
                                                            ...
                                                            <span x-numberformat>{{ $pointLog->points }}</span>
                                                            @php
                                                                $issuePoint = $pointLog->userPoint?->issuePoint;
                                                            @endphp
                                                            @if ($issuePoint)
                                                                จาก <a
