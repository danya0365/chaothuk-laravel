                    ...
                    <div
                        ...
                        <table class="w-full table-auto text-sm text-lef">
                            ...
                            <tbody class="bg-white dark:bg-gray-800">
                                @forelse ($missionStatusLogs as $missionStatus)
                                    @php
                                        $mission = $missionStatus->userMission;
                                            ...
                                            <dl class="divide-y divide-gray-100 dark:divide-gray-700">
                                                ...
                                                <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                    ...
                                                    <dd
                                                        class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-300 sm:col-span-2 sm:mt-0">
                                                        <a
                                                            href="{{ route('backend.users.show', $missionStatus->actionUser->id) }}">
                                                            {{ $missionStatus->actionUser->name ?? 'ยังไม่ได้ระบุ' }}
                                                        </a>
                                                    </dd>
                                                </div>
                                                <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                    ...
                                                    <dd
                                                        class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-300 sm:col-span-2 sm:mt-0">
                                                        <a
                                                            href="{{ route('backend.user-customers.show', $mission->customer->user_id) }}">
                                                            {{ $mission->customer->getPersonInfo()->getFullName() ?? 'ยังไม่ได้ระบุ' }}</a>
                                                    </dd>
                                                </div>
                                                <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                    <dt
                                                ...
                                                <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                    ...
                                                    <dd
                                                        class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-300 sm:col-span-2 sm:mt-0">
                                                        {{ $missionStatus->getMissionStatusFormat() }}
                                                    </dd>
                                                </div>
                                            </dl>
                                        </td>
