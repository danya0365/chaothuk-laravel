                    ...
                    <div
                        ...
                        <table class="w-full table-auto text-sm text-lef">
                            ...
                            <tbody class="bg-white dark:bg-gray-800">
                                @forelse ($pointTransactionLogs as $pointTransactionLog)
                                    <tr>
                                        <td
                                            ...
                                            <dl class="divide-y divide-gray-100 dark:divide-gray-700">
                                                ...
                                                <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                    ...
                                                    <dd
                                                        ...
                                                        <a
                                                            href="{{ route('backend.user-customers.show', $pointTransactionLog->user?->customer->user_id) }}">
                                                            {{ $pointTransactionLog->user?->customer->getPersonInfo()->getFullName() ?? 'ยังไม่ได้ระบุ' }}
                                                        </a>
                                                    </dd>
                                                </div>
                                                @if ($pointTransactionLog->points > 0)
                                                    <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                        <dt
                                                            class="text-sm font-medium leading-6 text-gray-900 dark:text-gray-100">
                                                            แต้มที่ได้รับ</dt>
                                                        <dd
                                                            ...
                                                            <span
                                                                x-numberformat>{{ $pointTransactionLog->points }}</span>
                                                        </dd>
                                                    </div>
                                                @else
                                                    <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                ...
                                                @endif
                                                @php
                                                    $transactionable = get_class($pointTransactionLog->transactionable);
                                                @endphp
                                                @if ($transactionable == 'App\Models\UserCoupon')
                                                    <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                        <dt
                                                            class="text-sm font-medium leading-6 text-gray-900 dark:text-gray-100">
                                                            แลกคูปอง</dt>
                                                        <dd
                                                            class="mt-1 text-sm leading-6 text-green-700 dark:text-green-300 sm:col-span-2 sm:mt-0 space-x-2">
                                                            <a
                                                                href="{{ route('backend.user-coupons.show', $pointTransactionLog->transactionable->id) }}">
                                                                {{ $pointTransactionLog->transactionable->bannerProduct->name }}
                                                            </a>
                                                        </dd>
                                                    </div>
                                                @endif
                                                @if ($transactionable == 'App\Models\UserMission')
                                                    <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                        <dt
                                                            class="text-sm font-medium leading-6 text-gray-900 dark:text-gray-100">
                                                            ทำภารกิจ</dt>
                                                        <dd
                                                            class="mt-1 text-sm leading-6 text-green-700 dark:text-green-300 sm:col-span-2 sm:mt-0 space-x-2">
                                                            <a
                                                                href="{{ route('backend.user-missions.show', $pointTransactionLog->transactionable->id) }}">
                                                                {{ $pointTransactionLog->transactionable->bannerPromotion->name }}
                                                            </a>
                                                        </dd>
                                                    </div>
                                                @endif
                                                @if ($transactionable == 'App\Models\IssuePoint')
                                                    <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                        <dt
                                                            class="text-sm font-medium leading-6 text-gray-900 dark:text-gray-100">
                                                            จากระบบ</dt>
                                                        <dd
                                                            class="mt-1 text-sm leading-6 text-green-700 dark:text-green-300 sm:col-span-2 sm:mt-0 space-x-2">
                                                            {{ $pointTransactionLog->transactionable->name }}
                                                        </dd>
                                                    </div>
                                                @endif
                                            </dl>
                                        ...
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 dark:border-gray-600"
                                            x-datetimeformat>
                                            {{ $pointTransactionLog->created_at }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="3"
