        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4 mx-auto sm:px-0 px-6 md:px-0 xl:px-0 lg:px-0">
                <h1 class="text-3xl font-bold">
                    Coupon Logs By {{ $merchant?->getMerchantName() ?? 'Merchant' }}
                </h1>
                <div class="flex mt-5">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            ...
                                                            <dl class="divide-y divide-gray-100 dark:divide-gray-700">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <dd
                                                                        class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-300 sm:col-span-2 sm:mt-0">
                                                                        {{ $user->merchant?->name ?? 'ยังไม่ได้ระบุ' }}
                                                                    </dd>
                                                                </div>
                                                            </dl>
                                                        </td>
                                                        <td
                                                            ...
                                                            <a class="text-green-600 dark:text-green-400 hover:text-green-900 dark:hover:text-green-200"
                                                                href="{{ route('backend.reports.coupon-logs-by-merchant', ['merchantId' => $user->id]) }}">
                    ...
                    <div class="flex flex-col">
                        <div
                            ...
                            <div
                                class="w-full px-6 py-4 bg-white dark:bg-gray-800 rounded shadow-md ring-1 ring-gray-900/10">
                                <form>
                                    <input type="hidden" name="merchantId" value="{{ $merchant->user_id }}" />
                                                ...
                                                <dl class="divide-y divide-gray-100 dark:divide-gray-700">
                                                    <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                        ...
                                                        <dd
                                                            class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-300 sm:col-span-2 sm:mt-0">
                                                            <a
                                                                href="{{ route('backend.user-customers.show', $couponLog->userCoupon?->customer->user_id) }}">
                                                                {{ $couponLog->userCoupon?->customer->getPersonInfo()->getFullName() ?? $couponLog->userCoupon?->customer->user_id }}
                                                            </a>
                                                        </dd>
                                                    </div>
                                                    <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                        ...
                                                        <dd
                                                            class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-300 sm:col-span-2 sm:mt-0">
                                                            <a
                                                                href="{{ route('backend.user-merchants.show', $couponLog->userCoupon?->bannerProduct->merchant->user_id) }}">
                                                                {{ $couponLog->userCoupon?->bannerProduct->merchant->getMerchantName() ?? 'ยังไม่ได้ระบุ' }}
                                                            </a>
                                                        </dd>
                                                    </div>
                                                    <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                        ...
                                                        <dd
                                                            class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-300 sm:col-span-2 sm:mt-0">
                                                            <a
                                                                href="{{ route('backend.user-coupons.show', $couponLog->userCoupon?->id) }}">
                                                                #{{ $couponLog->userCoupon?->id }}
                                                            </a>
                                                        </dd>
                                                    </div>
