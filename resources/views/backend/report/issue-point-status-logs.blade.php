                    ...
                    <div
                        ...
                        <table class="w-full table-auto text-sm text-lef">
                            ...
                            <tbody class="bg-white dark:bg-gray-800">
                                @forelse ($issuePointStatusLogs as $issuePointStatus)
                                    @php
                                        $issuePoint = $issuePointStatus->issuePoint;
                                        $mission = $issuePoint?->userMission;
                                    ...
                                    <tr>
                                            ...
                                            <dl class="divide-y divide-gray-100 dark:divide-gray-700">
                                                <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                    ...
                                                    <dd
                                                        ...
                                                        <a
                                                            href="{{ route('backend.users.show', $issuePointStatus->actionUser->id) }}">
                                                            {{ $issuePointStatus->actionUser->name ?? 'ยังไม่ได้ระบุ' }}
                                                        </a>
                                                    </dd>
                                                </div>
                                                <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                ...
                                                @if ($mission)
                                                    <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                        ...
                                                        <dd
                                                            class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-300 sm:col-span-2 sm:mt-0">
                                                            <a
                                                                href="{{ route('backend.user-missions.show', $mission->id) }}">
                                                                #{{ $mission->id }}
                                                            </a>
                                                        </dd>
                                                    </div>
                                                ...
                                                <div class="p-2 sm:grid sm:grid-cols-3 sm:gap-2 sm:px-0">
                                                    ...
                                                    <dd
                                                        class="mt-1 text-sm leading-6 text-gray-700 dark:text-gray-300 sm:col-span-2 sm:mt-0">
                                                        {{ $issuePointStatus->getIssuePointStatusFormat() }}
                                                    </dd>
                                                </div>
                                            </dl>
                                        </td>
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 dark:border-gray-600"
                                            x-datetimeformat>
                                            {{ $issuePointStatus->created_at }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="5"
