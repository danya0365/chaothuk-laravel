<div class="flex flex-col space-y-4">
    ...
    <div>
        <x-input-label for="is_can_approved" :value="__('สามารถ
                                                        Approved')" />
        <x-radio-input name="is_can_approved" class="mt-1 block w-full" required :selections="$yesNoSelections"
            :selected="$user->backend ? $user->backend->is_can_approved : 0" />
        <x-input-error :messages="$errors->get('is_can_approved')" class="mt-2" />
    </div>
