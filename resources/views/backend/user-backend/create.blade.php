            ...
            <div class="mb-4 mx-auto sm:px-0 px-6 md:px-0 xl:px-0 lg:px-0">
                ...
                @if (!Auth::user()->role?->isSupervisor())
                    <div class="p-4 rounded bg-red-500 text-red-100 mb-4">
                        <span>เฉพาะ{{ __('common.role-1') }}เท่านั้น ที่สามารถเพิ่มข้อมูล</span>
                    </div>
                @endif
                <div class="flex mt-5">
                ...
                <div class="flex flex-col">
                    <div
                        ...
                        <div
                            ...
                            <form action="{{ route('backend.user-backends.store') }}" method="POST">
                                @csrf

                                @include('backend.user-backend.form')
                            </form>
