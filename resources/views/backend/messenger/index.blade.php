        ...
        <div class="flex-1 flex flex-col">
            <main class="flex-grow flex flex-row min-h-0">
                <section class="flex flex-col flex-auto">
                    @include('backend.messenger.partials.header')
                    @include('backend.messenger.partials.conversation')
                    @include('backend.messenger.partials.footer')
                </section>
            </main>
        </div>
    </div>
            ...
            function alpineData() {
                return {
                    ...
                    getConversations: async function() {
                        const url = route('ajax.messenger.channel.conversations', this.channelId);
                    ...
                    onSubmit: async function() {
                        ...
                        const url = '{{ route('ajax.messenger.channel.conversations.store', $messengerChannel->id) }}';
