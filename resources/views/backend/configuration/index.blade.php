        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-4 mx-auto sm:px-0 px-6 md:px-0 xl:px-0 lg:px-0 hidden">
                <div class="flex justify-end ">
                    <a href="{{ route('backend.configurations.create') }}"
