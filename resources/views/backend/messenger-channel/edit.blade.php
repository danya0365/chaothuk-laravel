                ...
                <div class="flex flex-col">
                    <div
                        ...
                        <div
                            ...
                            <form action="{{ route('backend.messenger-channels.update', $messengerChannel->id) }}"
                                method="POST">
                                {{ method_field('PATCH') }}
                                @csrf
                                ...
                                <div class="flex flex-col space-y-4">
                                    <div>
                                        <x-input-label for="slug" :value="__('ชื่อตัวแปร')" />
                                        <x-text-input :value="$messengerChannel->slug" id="slug" name="slug" type="text"
                                    ...
                                    <div>
                                        ...
                                        <x-text-input :value="$messengerChannel->title" id="title" name="title" type="text"
                                            class="mt-1 block w-full" required />
