<x-backend-layout>
    <x-slot name="header">
        @include('backend.user-coupon.header')
    </x-slot>
                ...
                <div class="flex flex-col">
                    <div
                        ...
                        <div
                            ...
                            <form action="{{ route('backend.user-coupons.store') }}" method="POST">
                                @csrf

                                @if (!$customerId)
                                    @include('backend.user-coupon.select-customer')
                                @elseif (!$bannerProductId)
                                    @include('backend.user-coupon.select-banner-product')
                                @else
                                    @include('backend.user-coupon.form')
                                @endif
                            </form>
