                ...
                <div class="flex flex-col">
                    <div
                        ...
                        <div
                            ...
                            <form action="{{ route('backend.user-missions.store') }}" method="POST">
                                @csrf

                                @if (!$customerId)
                                    @include('backend.user-mission.select-customer')
                                @elseif (!$bannerPromotionId)
                                    @include('backend.user-mission.select-banner-promotion')
                                @else
                                    @include('backend.user-mission.form')
                                @endif
                            </form>
