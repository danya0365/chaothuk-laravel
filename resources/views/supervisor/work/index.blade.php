    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-end">
                <a href="{{ route('supervisor.works.create') }}" class="px-2 py-1 rounded-md bg-blue-500 text-sky-100 hover:bg-blue-700">+ Create New Post</a>
            </div>
                        ...
                        <table class="w-full table-auto text-sm text-lef">
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $work->code }}</td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{{ $work->title }}</td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <form action="{{ route('supervisor.works.destroy', $work->id) }}" method="POST">
                            
                                            <a class="text-indigo-600 hover:text-indigo-900" href="{{ route('supervisor.works.show',$work->id) }}">
                                            ...
                                            <a href="{{ route('supervisor.works.edit',$work->id) }}" class="text-indigo-600 hover:text-indigo-900 text-gray-600">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
