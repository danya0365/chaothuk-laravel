            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    <a href="/" class="flex items-center gap-2">
                        ...
                        <span class="font-black text-2xl bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-amber-500 dark:from-orange-400 dark:to-amber-300 tracking-tight">
                            Chaothuk
                        </span>
                    </a>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <!-- Dark Mode Toggle -->
                    <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-full text-sm p-2.5 transition">
                    ...
                    @else
                        ...
                        <a href="{{ route('frontend.auth.register') }}" class="inline-flex items-center justify-center px-5 py-2.5 text-sm font-bold text-white transition-all duration-200 bg-orange-600 rounded-full hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-600 shadow-lg shadow-orange-600/30 dark:shadow-orange-500/20">
                            เริ่มต้นใช้งานฟรี
                        </a>
                    @endauth
                </div>
