        ...
        <div class="flex-1 flex flex-col">
            <main class="flex-grow flex flex-row min-h-0">
                <section class="flex flex-col flex-auto">
                    @include('messenger.mobile-phone-channel.partials.header')
                    @include('messenger.mobile-phone-channel.partials.conversation')
                    @include('messenger.mobile-phone-channel.partials.footer')
                </section>
            </main>
        </div>
    </div>
            ...
            function alpineData() {
                return {
                    ...
                    getConversations: async function() {
                        const url =
                            '{{ route('ajax.messenger.mobile-phone-channel.conversations', ['channelId' => $messengerChannel->id, 'mobilePhone' => $mobilePhone]) }}';
                    ...
                    onSubmit: async function() {
                        ...
                        const url =
                            '{{ route('ajax.messenger.mobile-phone-channel.conversations.store', ['channelId' => $messengerChannel->id, 'mobilePhone' => $mobilePhone]) }}';
