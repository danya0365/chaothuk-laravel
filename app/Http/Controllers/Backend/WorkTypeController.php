...
class WorkTypeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.work-type.index', compact('workTypes'))
    ...
    public function create()
    {
        ...
        return view('backend.work-type.create', compact('workType'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.work-type.show', compact('workType'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.work-type.edit', compact('workType'));
    }
