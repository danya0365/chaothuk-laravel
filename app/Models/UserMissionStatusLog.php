...
class UserMissionStatusLog extends Model
{
     ...
     */
    protected $fillable = ['user_mission_id', 'action_user_id', 'user_mission_status'];
    ...
    {
        return __('mission.status-' . $this->user_mission_status);
    }
}
